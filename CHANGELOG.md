...
- Reworked the dashboard home layout into a denser horizontal filter deck with a smaller search strip and tighter title branding.
- Moved running-state filters and the reset-view action into the top header so they align with the settings, refresh, and compact controls.
